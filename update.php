    ...
    $update_product_id=$_POST['update_product_id'];
     ...
     //echo $update_product_name;
      $update_product_price=$_POST['update_product_price'];
       ...
       $update_products=mysqli_query($conn,"UPDATE myproducts SET name='$update_product_name',price='$update_product_price',image='$update_product_image' 
...
<section class="edit_container">
    ...
    if(isset($_GET['edit'])){
        $edit_id=$_GET['edit'];
        //echo $edit_id;
        $edit_query=mysqli_query($conn,"SELECT * FROM myproducts WHERE id=$edit_id");
        ...
        <div class="btns">
            ...
            <input type="reset" id="cose-edit" value="Cancel" class="cancel_btn">
        </div>
    </form>
            <?php
        }
